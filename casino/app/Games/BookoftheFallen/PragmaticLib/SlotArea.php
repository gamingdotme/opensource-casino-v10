...
class SlotArea
{
    ...
    public static function setStf(&$slotArea, $gameSettings, $log, $pur, $ind){
        // set rtf at the ratio of 20%
        if($pur == -1 || $log && array_key_exists('fs', $log)){
