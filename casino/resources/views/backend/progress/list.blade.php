					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="type" id="type" class="form-control">
								...
								<option value="one_pay" {{ Request::get('type') == 'one_pay' ? 'selected' : '' }}>{{ __('app.one_pay') }}</option>
								<option value="sum_pay" {{ Request::get('type') == 'sum_pay' ? 'selected' : '' }}>{{ __('app.sum_pay') }}</option>
							</select>
						</div>
					</div>
				</div>
