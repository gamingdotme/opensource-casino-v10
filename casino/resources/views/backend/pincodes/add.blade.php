...
<section class="content">
	<form action="{{ route('backend.pincode.massadd') }}" method="POST" enctype="multipart/form-data">
		@csrf
	...
	<form action="{{ route('backend.pincode.store') }}" method="POST" enctype="multipart/form-data" id="user-form">
		@csrf
