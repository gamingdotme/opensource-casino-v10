...
<section class="content">
	@if ($edit)
		<form action="{{ route('backend.permission.update', $permission->id) }}" method="POST" id="permission-form">
			@method('PUT') 

	@else
		<form action="{{ route('backend.permission.store') }}" method="POST" id="permission-form">
	@endif
			@csrf
			<div class="box box-default">
				...
				<div class="box-footer">
					...
					@if ($edit && $permission->removable)
						<a href="{{ route('backend.permission.delete', $permission->id) }}" class="btn btn-danger" data-method="DELETE" data-confirm-title="@lang('app.please_confirm')" data-confirm-text="@lang('app.are_you_sure_delete_permission')" data-confirm-delete="@lang('app.yes_delete_it')">
							Delete Permission
						</a>
					@endif
				</div>
