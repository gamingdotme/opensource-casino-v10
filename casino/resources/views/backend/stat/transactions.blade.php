				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<select name="type_in_out" class="form-control">
								<option value="0" {{ Request::get('type_in_out') == 0 ? 'selected' : '' }}>
									{{ __('app.no') }}
								</option>
								<option value="1" {{ Request::get('type_in_out') == 1 ? 'selected' : '' }}>
									{{ __('app.yes') }}
								</option>
							</select>
						</div>
						...
						<div class="form-group">
							...
							<select name="system" id="system" class="form-control">
								@foreach ($systems as $value => $label)
									<option value="{{ $value }}" {{ Request::get('system') == $value ? 'selected' : '' }}>
										{{ $label }}
									</option>
								@endforeach
							</select>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="role" id="role" class="form-control">
								<option value="" {{ Request::get('role') === null ? 'selected' : '' }}>---</option>
						...
						<div class="form-group">
							...
							<select name="shifts" id="shifts" class="form-control">
								@foreach ($filter as $value => $label)
									<option value="{{ $value }}" {{ Request::get('shifts') == $value ? 'selected' : '' }}>
										{{ $label }}
									</option>
								@endforeach
							</select>
			...
			<div class="table-responsive">
				<table class="table table-bordered table-striped">
					...
					<tbody>
						...
						@else
							<tr>
								<td colspan="18">@lang('app.no_data')</td>
							</tr>
						@endif
					</tbody>
					<thead>
