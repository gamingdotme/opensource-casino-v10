									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<select name="type" id="type" class="form-control">
												...
												<option value="PayStat" {{ $filter == 'PayStat' ? 'selected' : '' }}>Pay Stats</option>
												<option value="StatGame" {{ $filter == 'StatGame' ? 'selected' : '' }}>Game Stats</option>
												<option value="BankStat" {{ $filter == 'BankStat' ? 'selected' : '' }}>Bank Stats</option>
												<option value="ShopStat" {{ $filter == 'ShopStat' ? 'selected' : '' }}>Shop Stats</option>
											</select>
										</div>
									</div>
								</div>
					...
					<div id="transactions_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4  p-0 m-0 ">
						...
						<table class="table table-striped table-bordered table-sm dataTable no-footer" id="stat-table">
							...
							<tbody>
								...
								@else
									<tr>
										<td colspan="15">@lang('app.no_data')</td>
									</tr>
								@endif
							</tbody>
							<thead>
