		...
		<div class="element-wrapper">
			<div class="element-box">
				...
				@if(Auth::user()->hasRole('cashier'))
					...
					<form action="{{ route('backend.user.massadd') }}" method="POST" enctype="multipart/form-data" id="mass-user-form">
						@csrf
				...
				<form action="{{ route('backend.user.store') }}" method="POST" enctype="multipart/form-data" id="user-form">
					@csrf
					<legend><span>
							@lang('app.add_user')
						</span></legend>
