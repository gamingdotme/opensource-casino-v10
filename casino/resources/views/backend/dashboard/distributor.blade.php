...
<style>
	.content-w table.dataTable th,
	.content-w table.dataTable td {
							...
							<div class="table-responsive">
								<table class="table table-hover table-bordered dataTable no-footer">
									...
									<tbody>
										...
										@else
											<tr>
												<td colspan="17">@lang('app.no_data')</td>
											</tr>
										@endif
						...
						<div class="rowrightdiv text-center mt-4">
							...
							@if(Auth::user()->shop)
								@if(Auth::user()->shop->is_blocked)
									...
									<div class="col-md-12"><a class="btn btn-danger" href="{{ route('backend.settings.shop_unblock') }}" data-method="PUT" data-confirm-title="@lang('app.please_confirm')" data-confirm-text="@lang('app.are_you_sure_unblock_shop')" data-confirm-delete="@lang('app.unblock')"> UnBlock Shop</a></div>
									@endpermission
								@else
									@permission('shops.block')
									<div class="col-md-12"><a class="btn btn-danger" href="{{ route('backend.settings.shop_block') }}" data-method="PUT" data-confirm-title="@lang('app.please_confirm')" data-confirm-text="@lang('app.are_you_sure_block_shop')" data-confirm-delete="@lang('app.block')"> Block Shop</a></div>
									@endpermission
								@endif
							@endif
							@if(Auth::user()->hasRole('distributor') && auth()->user()->present()->shop)
								...
								<div class="col-md-12">
									<a class="btn btn-link" href="{{ route('backend.shop.action', [auth()->user()->present()->shop, 'jpg_out']) }}" data-method="DELETE" data-confirm-title="@lang('app.please_confirm')" data-confirm-text="{{ auth()->user()->present()->shop->name }} / @lang('app.jpg_out')" data-confirm-delete="@lang('app.yes_delete_him')"> @lang('app.jpg_out')</a>
								</div>
								<div class="col-md-12">
									<a class="btn btn-link" href="{{ route('backend.shop.action', [auth()->user()->present()->shop, 'games_out']) }}" data-method="DELETE" data-confirm-title="@lang('app.please_confirm')" data-confirm-text="{{ auth()->user()->present()->shop->name }} / @lang('app.games_out')" data-confirm-delete="@lang('app.yes_delete_him')"> @lang('app.games_out')</a>
								</div>
								<div class="col-md-12">
									<a class="btn btn-link" href="{{ route('backend.shop.action', [auth()->user()->present()->shop, 'return_out']) }}" data-method="DELETE" data-confirm-title="@lang('app.please_confirm')" data-confirm-text="{{ auth()->user()->present()->shop->name }} / @lang('app.returns_out')" data-confirm-delete="@lang('app.yes_delete_him')"> @lang('app.returns_out')</a>
								</div>
							@endif
