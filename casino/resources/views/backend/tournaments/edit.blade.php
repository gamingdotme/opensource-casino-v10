...
<section class="content">
	<form action="{{ route('backend.tournament.update', $tournament->id) }}" method="POST" enctype="multipart/form-data" id="tournament-form">
		@csrf
		<div class="box box-default">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-striped">
									...
									<tbody>
										...
										@else
											<tr>
												<td colspan="5">@lang('app.no_data')</td>
											</tr>
										@endif
									</tbody>
									<thead>
			...
			<div class="box-footer">
				...
				<a href="{{ route('backend.tournament.delete', $tournament->id) }}" class="btn btn-danger" data-method="DELETE" data-confirm-title="@lang('app.please_confirm')" data-confirm-text="@lang('app.are_you_sure_delete_tournament')" data-confirm-delete="@lang('app.yes_delete_him')">
