...
<html class="ie9up" lang="en"><!--<![endif]-->
	...
	<head>
		...
		<script src="/frontend/Warmest/js/jquery-3.4.1.min.js"></script>
    ...
    <script src="/woocasino/js/respond.min.js"></script><![endif]-->
		...
		<!-- White CSS -->
		<link href="/woocasino/warmestcss/reset.css" rel="stylesheet" type="text/css" class="styles" />
		<!-- Flags -->
		<link rel="stylesheet" href="/woocasino//flag-icon-css/css/flag-icon.min.css">
		<!-- Perfect scrollbar css -->
		<link rel="stylesheet" type="text/css" href="/woocasino/warmestcss/perfect-scrollbar.css">
		<!-- zebra datepicker -->
		<link rel="stylesheet" type="text/css" href="/woocasino/warmestcss/zebra_datepicker.css">
		<!-- START OF ALL CUSTOM CSS + FONTS -->
		<link href="/woocasino/warmestcss/style.css" rel="stylesheet" type="text/css" />

		<link href="/woocasino/warmestcss/regional.css" rel="stylesheet" type="text/css" />
		<link rel="stylesheet" href="/woocasino/warmestcss/oct7vfe.css">
...
-->
		...
		@include('frontend.Warmest.partials.navbar')
		...
		<div class="ls__fixed__btn">
			<div class="footer__item-search">
				<span class="search-wrap"><input type="text" placeholder="Search Game" class="search" style="    border-radius: 15px;width: 100%;padding: 1px 15px;border-style: double;"></span>
			</div>
		</div>
	<script>
	let debounceTimer;
	...
	function doSearch(query) {
		...
		{{-- @include('frontend.Warmest.partials.popups') --}}
		@include('frontend.Warmest.partials.popups')
		...
		<script>
			...
			//Category to show in the Featured tab by White
