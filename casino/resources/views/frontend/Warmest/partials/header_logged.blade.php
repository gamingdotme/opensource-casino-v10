...
<link rel="stylesheet" href="/woocasino/warmestcss/appef20.css?v=1.1.6">
<style type="text/css">
	.info-value {
		color: grey;
	}
									...
									<div class="header-auth__anon-btn-wrp">
										...
										@if(Auth::check())
															<a href="#" data-name="modal-kassa" class="footer__item-tab paymentsMenu
																																																																														...
																																																																														">
																<div class="footer__item-tab-img"><img src="/frontend/Warmest/img/svg/bit-icon.svg" alt=""></div>
															</a>
	...
	<div class="popup">
		<div class="popup__body">
						...
						<div class="deposit__item">
							<div class="deposit__box">
								...
								<div class="deposit__payments">
									<img src="/frontend/Warmest/img/_src/logo-kassa-2.png" alt="" class="deposit__payments-img">
								</div>
							</div>
					...
					@if(settings('payment_btcpayserver') && \VanguardLTE\Lib\Setting::is_available('btcpayserver', auth()->user()->shop_id))
						<div class="deposit__item">
							<div class="deposit__box">
								...
								<div class="deposit__payments">
									<img src="/frontend/Warmest/img/_src/logo-kassa-3.png" alt="" class="deposit__payments-img">
								</div>
							</div>
							<div class="deposit__cont" style="overflow: hidden; display: none;">
								<form action="{{ route('frontend.balance.post') }}" method="POST">
					...
					@if(settings('payment_pin'))
						<div class="deposit__item">
							<div class="deposit__box">
								...
								<div class="deposit__payments">
									<img src="/frontend/Warmest/img/_src/logo-kassa-4.png" alt="" class="deposit__payments-img">
								</div>
							</div>
							<div class="deposit__cont" style="overflow: hidden; display: none;">
								<form action="{{ route('frontend.balance.post') }}" method="POST">
			...
			<div class="popup__cont" id="div_withdraw">
				<p style="color: #ff0000;font-size: 16px;font-weight:normal;"><img src="/frontend/Warmest/img/_src/arrow-dis.png" style="float: left;position: relative;top: -13px;margin-right: 12px;}" /> </p>
				<br><br>
				<header class="modal__header">
					<div class="span modal__title">@lang('app.money_date')</div>
				</header>
				<form action="{{ route('frontend.profile.withdraw') }}" method="POST">
					@csrf
	...
	<div class="modal__body">
		<div class="modal__content">
			...
			<p data-nsfw-filter-status="swf" style="text-align: center;">
				<img src="/frontend/Warmest/img/user1.png" data-nsfw-filter-status="sfw" style="visibility: visible;">
			</p>
			...
			<div class="modal__table" style="width: 100%; height: auto;">
				<div>
					...
					<div class="col-6" style="padding: 30px;"><img src="/frontend/Warmest/img/casino1.jpg" style="visibility: visible; width: 50%;float: right;"></div>
				</div>
			</div>
			<div class="modal__error" style="display: none"></div>
		</div>
