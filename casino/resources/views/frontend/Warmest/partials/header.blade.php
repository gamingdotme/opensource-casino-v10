...
<div class="container">
    ...
    <div class="header @yield('add-header-class')">
        ...
        <div class="mobMenu">
            <img src="/frontend/Warmest/img/badges64x64/badge-{{ auth()->user()->badge() }}.png" alt="" width="32" height="32">
        </div>!-->
                        ...
                        <div class="mobile-menu__item-acc-img">
                            @if( auth()->user()->shop && auth()->user()->shop->progress_active )
                                <a href="{{ route('frontend.progress') }}">
                                    <img src="/frontend/Warmest/img/badges64x64/badge-{{ auth()->user()->badge() }}.png" alt="" width="72" height="72">
                                </a>
                            @else
                                <img src="/frontend/Warmest/img/badges64x64/badge-{{ auth()->user()->badge() }}.png" alt="" width="72" height="72">
                            @endif
