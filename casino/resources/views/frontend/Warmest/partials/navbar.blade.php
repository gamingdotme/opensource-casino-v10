...
<section  id="woocasino" class="carcass">
    @if (Auth::check())
        @include('frontend.Warmest.partials.header_logged')
    @else
        @include('frontend.Warmest.partials.header_not_logged')
    @endif
    <div class="top-bar">
        <!-- jackpot -->

        <div style="display: flex;">
            <img class="header-auth__logo" src="/frontend/Warmest/img/casino1.png" alt="">
        </div>
        <!-- jackpot -->
        <div class="top-bar__content">
            ...
            @else
            <link rel="stylesheet" href="/woocasino/warmestcss/payment.css">
                                    ...
                                    <a class="providers-mob__link providers-mob__link--exclusive" scroll-up="" href="{{ route('frontend.game.list.category', $category->href) }}">
                                        <span class="providers-mob__icon-wrp">
                                            <span class="providers-mob__icon">
                                                <img class="providers-mob__icon-img providers-mob__icon-img--pragmaticplay" src="/frontend/Warmest/svg/{{$category->href}}.svg">
                                            </span>
