@extends('frontend.Simple.layouts.app')
															...
															@for ($i = 0; $i < 5; $i++)
																						...
																						<li class="last-winners__item ng-scope">
																							<button class="last-winners__img-block">
																								<img class="last-winners__img" src="/frontend/Simple/ico/{{ $g->name }}.jpg">
							...
							@foreach ($top_categories as $k => $v)
									...
									<a class="providers__link" scroll-up="" href="{{ route('frontend.game.list.category', $v) }}">
										<span class="providers__icon">
											<img class="providers__icon-img providers__icon-img--{{$v}}" alt="{{$v}}" src="/frontend/Simple/svg/{{$v}}.svg">
										</span>
										...
										@if (!in_array($category->href, $top_categories))
											<li class="providers__dropdown-item ng-scope">
												<a class="providers__link" href="{{ route('frontend.game.list.category', $category->href) }}">
													<span class="providers__icon">
														<img class="providers__icon-img providers__icon-img--1x2gaming" alt="" src="/frontend/Simple/svg/{{$category->href}}.svg">
													</span>
						...
						@foreach ($games as $key => $game)
								...
								<div class="game-item game-item--overflow ng-scope">
									<div class="game-item__block">
										<img class="game-item__img" src="{{ $game->name ? '/frontend/Simple/ico/' . $game->name . '.jpg' : '' }}" casino-lazy-src="{{ $game->name ? '/frontend/Simple/ico/' . $game->name . '.jpg' : '' }}" alt="{{ $game->title }}" loading="true" style="opacity: 1;">
