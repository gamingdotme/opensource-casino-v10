...
<html class="ie9up" lang="en"><!--<![endif]-->
	...
	<head>
		...
		<script src="/frontend/Simple/js/jquery-3.4.1.min.js"></script>
    ...
    <script src="/woocasino/js/respond.min.js"></script><![endif]-->
		...
		<!-- White CSS -->
		<link href="/woocasino/simplecss/reset.css" rel="stylesheet" type="text/css" class="styles" />
		<!-- Flags -->
		<link rel="stylesheet" href="/woocasino//flag-icon-css/css/flag-icon.min.css">
		<!-- Perfect scrollbar css -->
		<link rel="stylesheet" type="text/css" href="/woocasino/simplecss/perfect-scrollbar.css">
		<!-- zebra datepicker -->
		<link rel="stylesheet" type="text/css" href="/woocasino/simplecss/zebra_datepicker.css">
		<!-- START OF ALL CUSTOM CSS + FONTS -->
		<link href="/woocasino/simplecss/style.css" rel="stylesheet" type="text/css" />

		<link href="/woocasino/simplecss/regional.css" rel="stylesheet" type="text/css" />
		<link rel="stylesheet" href="/woocasino/simplecss/oct7vfe.css">
...
-->
		...
		@include('frontend.Simple.partials.navbar')
	...
	function doSearch(query) {
		...
		{{-- @include('frontend.Simple.partials.popups') --}}
		@include('frontend.Simple.partials.popups')
