            ...
            @foreach($bonuses AS $item)
                ...
                @if( $item['is_first'] )
                    @if($item['type'] == 'happyhour')
                        <div class="bonus-page__banner bonus-banner" style="background-image: url('/frontend/Simple/img/_src/banner-bg.png')">
                    ...
                    @if( !$item['is_first'] )
                        @if($item['type'] == 'happyhour')
                            <div class="bonus-cards__item">
                                ...
                                <div class="bonus-cards__img">
                                    <img src="/frontend/Simple/img/_src/WelcomeBonus3.png" alt="">
                                </div>
                        ...
                        @elseif($item['type'] == 'progress')
                            <div class="bonus-cards__item">
                                ...
                                <div class="bonus-cards__img">
                                    <img src="/frontend/Simple/img/_src/ProgressBonus.png" alt="">
                                </div>
                                <div class="bonus-cards__info">
                        ...
                        @elseif($item['type'] == 'invite')
                            ...
                            <div class="bonus-cards__item">
                                ...
                                <div class="bonus-cards__img">
                                    <img src="/frontend/Simple/img/_src/InviteFriends.png" alt="">
                                </div>
                                <div class="bonus-cards__info">
                        ...
                        @elseif($item['type'] == 'sms_bonus')
                            <div class="bonus-cards__item">
                                ...
                                <div class="bonus-cards__img">
                                    <img src="/frontend/Simple/img/_src/SMSBonus.png" alt="">
                                </div>
                                <div class="bonus-cards__info">
                        ...
                        @elseif($item['type'] == 'welcome_bonus')
                            ...
                            <div class="bonus-cards__item">
                                ...
                                <div class="bonus-cards__img">
                                    <img src="/frontend/Simple/img/_src/WelcomeBonus{{ $item['data']->pay }}.png" alt="">
                                </div>
                                <div class="bonus-cards__info">
...
@section('scripts')
	@include('frontend.Simple.partials.scripts')
@endsection
