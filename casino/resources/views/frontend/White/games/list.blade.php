@extends('frontend.White.layouts.app')
                            ...
                            <div class="main-content__latest-winners last-winners ng-isolate-scope">
                                ...
                                <ul class="last-winners__list ng-scope">
                                    @if(count($games) > 0)
                                        ...
                                        $p = ['Om****','Ro****','Om****','Ji****','Th****','Le****','Ki****','Om****','St****','Pi****','Je****','Go****', 'Om****', 'Da****','Go****','Lo****','Hi****','Bf****','Sz****','We****','Ae****','Qt****','Ph****','Js****','Pl****', 'Yg****', 'Nh****', 'Su****'];
                                        @endphp
                                        <li class="last-winners__item ng-scope">
                                            <button class="last-winners__img-block">
                                                <img class="last-winners__img" src="/frontend/White/ico/{{ $g->name }}.jpg">
                                ...
                                <li class="providers__item ng-scope">
                                    <a class="providers__link" scroll-up="" href="{{ route('frontend.game.list.category', $v) }}">
                                        <span class="providers__icon">
                                            <img class="providers__icon-img providers__icon-img--{{$v}}" alt="{{$v}}" src="/frontend/White/svg/{{$v}}.svg">
                                        </span>
                            ...
                            @if ($categories && count($categories))
                                ...
                                <li class="providers__dropdown-item ng-scope">
                                    <a class="providers__link" href="{{ route('frontend.game.list.category', $category->href) }}">
                                        <span class="providers__icon">
                                            <img class="providers__icon-img providers__icon-img--1x2gaming" alt="" src="/frontend/White/svg/{{$category->href}}.svg">
                                        </span>
                            ...
                            <div class="game-item ng-scope">
                                <div class="game-item game-item--overflow ng-scope">
                                    <div class="game-item__block">
                                        <img class="game-item__img" src="{{ $game->name ? '/frontend/White/ico/' . $game->name . '.jpg' : '' }}" casino-lazy-src="{{ $game->name ? '/frontend/White/ico/' . $game->name . '.jpg' : '' }}" alt="{{ $game->title }}" loading="true" style="opacity: 1;"> 
