...
<html class="ie9up" lang="en"><!--<![endif]-->
	...
	<head>
		...
		<script src="/frontend/White/js/jquery-3.4.1.min.js"></script>
    ...
    <script src="/woocasino/js/respond.min.js"></script><![endif]-->
		...
		<!-- White CSS -->
		<link href="/woocasino/whitecss/reset.css" rel="stylesheet" type="text/css" class="styles" />
		<!-- Flags -->
		<link rel="stylesheet" href="/woocasino//flag-icon-css/css/flag-icon.min.css">
		<!-- Perfect scrollbar css -->
		<link rel="stylesheet" type="text/css" href="/woocasino/whitecss/perfect-scrollbar.css">
		<!-- zebra datepicker -->
		<link rel="stylesheet" type="text/css" href="/woocasino/whitecss/zebra_datepicker.css">
		<!-- START OF ALL CUSTOM CSS + FONTS -->
		<link href="/woocasino/whitecss/style.css" rel="stylesheet" type="text/css" />

		<link href="/woocasino/whitecss/regional.css" rel="stylesheet" type="text/css" />
		<link rel="stylesheet" href="/woocasino/whitecss/oct7vfe.css">
...
-->
		...
		@include('frontend.White.partials.navbar')
	...
	function doSearch(query) {
		...
		{{-- @include('frontend.White.partials.popups') --}}
		@include('frontend.White.partials.popups')
