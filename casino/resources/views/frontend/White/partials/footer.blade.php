				...
				<div class="footer__item-acc">
					<div class="footer__item-acc-img">
						<a href="javascript:;" data-name="modal-info" class="modal-btn">
							<!-- <img src="/frontend/White/img/badges64x64/badge-{{ auth()->user()->badge() }}.png" class="rating" > -->
				...
				<div class="footer__item-tabs">
					{{-- <a href="{{route('frontend.pincode.list')}}" class="footer__item-tab">
						<div class="footer__item-tab-img">
							<img src="/frontend/White/img/svg/kassa.svg" alt="">
						</div>
					...
					@endif
						...
						<div class="footer__item-tab-img">
							<img src="/frontend/White/img/svg/sms.svg" alt="">
						</div>
					...
					<a href="javascript:;" data-name="modal-loot" class="footer__item-tab modal-btn">
						<div class="footer__item-tab-img">
							<img src="/frontend/White/img/svg/coleso.svg" alt="">
						</div>
					...
					<a href="javascript:;" data-name="modal-bonus" class="footer__item-tab modal-btn">
						<div class="footer__item-tab-img">
							<img src="/frontend/White/img/_src/lootbox.png" alt="">
						</div>
...
foreach (glob(resource_path() . '/lang/*', GLOB_ONLYDIR) as $fileinfo) {
	...
	$langs[$dirname] = $dirname;
			...
			<span class="close-btn">
				<img src="/frontend/White/img/_src/close.svg" alt="">
			</span>
		</div>
	</div>
</div>
						...
						<div class="modal__slider-item">
							<div class="modal__slider-row">
								<div class="modal__slider-img">
									<img src="/frontend/White/img/badges64x64/badge-01.png" alt="">
			...
			<div class="modal__kassa">
				...
				<div class="modal__kassa-row">
													...
													<form action="{{ route('frontend.balance.post') }}" method="POST">
														...
														<div class="modal__kassa-row-item">
															<div class="modal__kassa-row-img">
																<img src="/frontend/White/img/_src/logo-{{ $system['ps'] }}.png" alt="">
															</div>
							...
							!(
								...
								!settings('coinbase_webhook_key_shop_' . auth()->user()->shop_id)
											...
											<form action="{{ route('frontend.balance.post') }}" method="POST">
												...
												<div class="modal__kassa-row-item">
													<div class="modal__kassa-row-img">
														<img src="/frontend/White/img/_src/logo-kassa-2.png" alt="">
													</div>
													<div class="modal__kassa-row-input">
														<input type="text" placeholder="Enter the amount" name="summ">
													</div>
							...
							!(
								...
								!settings('btcpayserver_store_id_shop_' . auth()->user()->shop_id)
											...
											<form action="{{ route('frontend.balance.post') }}" method="POST">
												...
												<div class="modal__kassa-row-item">
													<div class="modal__kassa-row-img">
														<img src="/frontend/White/img/_src/logo-kassa-3.png" alt="">
													</div>
													<div class="modal__kassa-row-input">
														<input type="text" placeholder="Enter the amount" name="summ">
													</div>
					...
					@if(setting('payment_pin'))
						<div class="modal__kassa-row-item">
							<div class="modal__kassa-row-img">
								<img src="/frontend/White/img/_src/logo-kassa-4.png" alt="">
							</div>
							<div class="modal__kassa-row-input">
						...
						<tbody>
							...
							@if($progress)
								@foreach($progress as $item)
									<tr>
										<td class="big-td"><img src="/frontend/White/img/badges64x64/badge-{{ $item->badge() }}.png" alt="">Range #{{ $item->rating }}</td>
										<td>{{ $item->sum }}</td>
...
<div class="popup popup-1">
	<div class="popup__body">
		<div class="popup__content" style="background-image: url('/frontend/White/img/_src/popup-bg-1.png')">
...
<div class="popup popup-2">
	<div class="popup__body">
		<div class="popup__content">
			<div class="popup__bg" style="background-image: url('/frontend/White/img/_src/popup-bg-2.png')"></div>
			<div class="popup__value">
				<img src="/frontend/White/img/badges320x320/badge-15.png" alt="">
			</div>
			<div class="popup__info">
				<div class="popup__title">
					Congratulations!
