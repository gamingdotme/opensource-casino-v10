...
class WinChecker
{
    ...
    public function getWin($pur, $log, $bet, $slotArea, $gameSettings){
        $psym = SlotArea::getPsym($gameSettings, $slotArea['SlotArea'], $bet, $gameSettings['l']);
        ...
        return ['TotalWin' => number_format($totalWin + $psym['psymwin'], 2, ".", ""), 'WinLines' => $winSymbols];
		}
