...
namespace VanguardLTE\Games\JohnHunterandtheTomboftheScarabQueen\PragmaticLib;
...
class Spin
{
    public static function spinResult($user, $game, $bet, $lines, $log, $gameSettings, $index, $counter, $callbackUrl, $pur, $bank, $shop, $jpgs){
        ...
        if($currentLog && array_key_exists('fs_total', $currentLog) && $currentLog['na'] == 's') $reelSet = 2;
